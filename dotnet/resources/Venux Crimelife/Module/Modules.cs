...
namespace Venux
{
    public sealed class Modules
    {
        ...
        private Modules()
        {
            this.modules = new Dictionary<Type, BaseModule>();
        ...
        public void Load(Type moduleType, bool reload = false)
        {
            if (!this.modules.ContainsKey(moduleType))
                ...
                this.modules[moduleType].Load(reload);
        }

        public bool Reload(string name)
        {
            foreach (KeyValuePair<Type, BaseModule> module in this.modules)
            {
        ...
        public Dictionary<Type, BaseModule> GetAll() => this.modules;

        private void Register(BaseModule module) => this.modules.Add(module.GetType(), module);
    }
}

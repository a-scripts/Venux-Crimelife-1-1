...
namespace Venux
{
    class TabletModule : Module<TabletModule>
    {
        ...
        public void supportTeleportToPlayer(Player c, string t)
        {
            try
            {
                if (c == null) return;
        ...
        public void supportRevivePlayer(Player c, string t)
        {
            try
            {
                if (c == null) return;
        ...
        public void supportBringPlayer(Player c, string t)
        {
            try
            {
                if (c == null) return;

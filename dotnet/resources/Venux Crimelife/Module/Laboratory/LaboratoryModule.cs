...
namespace Venux
{
    class LaboratoryModule : Module<LaboratoryModule>
    {
		...
		protected override bool OnLoad()
		{
				...
				try
				{
					if (((DbDataReader)(object)reader).HasRows)
					{
						while (((DbDataReader)(object)reader).Read())
						{
							...
							NAPI.Blip.CreateBlip(499, laboratory.Entrance, 0.4f, (byte)FactionModule.getFactionById(laboratory.FactionId).Blip, "Labor - " + FactionModule.getFactionById(laboratory.FactionId).Name, 255, 0, true, 0);
						}
					}
				}
				finally
			...
			NAPI.Marker.CreateMarker(25, EphiDustProcessingPoint, new Vector3(), new Vector3(), 1f, new Color(255, 140, 0), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(25, LaboratoryInteriorPoint, new Vector3(), new Vector3(), 1f, new Color(255, 140, 0), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(25, BatteryProcessingPoint, new Vector3(), new Vector3(), 1f, new Color(255, 140, 0), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(25, MaterialStoragePoint, new Vector3(), new Vector3(), 1f, new Color(255, 140, 0), false, uint.MaxValue);
			NAPI.Marker.CreateMarker(25, MaterialProductsPoint, new Vector3(), new Vector3(), 1f, new Color(255, 140, 0), false, uint.MaxValue);
			return true;
		}

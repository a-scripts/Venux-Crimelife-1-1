...
namespace Venux
{
    class Mietvertrag : Script
    {
        ...
        public void sendMietvertrag(Player c, string text)
        {
            ...
            {
                House house2 = HouseModule.houses.Find((House house2) => house2.OwnerId == dbPlayer2.Id || house2.TenantsIds.Contains(dbPlayer2.Id));
        ...
        public void acceptMietvertrag(Player c, string ownerid2, string houseid2)
        {
            ...
            House house = HouseModule.houses.Find((House house2) => house2.Id == HouseId);
            if (house == null) return;

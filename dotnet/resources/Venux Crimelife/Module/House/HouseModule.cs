...
namespace Venux
{
    class HouseModule : Module<HouseModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            NAPI.Marker.CreateMarker(1, new Vector3(1138, -3198, -40).Subtract(new Vector3(0, 0, 1)), new Vector3(), new Vector3(), 0.4f, new Color(255, 140, 0), false, uint.MaxValue);
            ...
            NAPI.Marker.CreateMarker(1, new Vector3(1130, -3194, -40).Subtract(new Vector3(0, 0, 1.4)), new Vector3(), new Vector3(), 0.4f, new Color(255, 140, 0), false, uint.MaxValue);
        ...
        {
            return houses.Find((House house) => house.Id == id);
        }
        ...
        public static void loadHouse(MySqlDataReader reader)
        {
            try
            {
                ...
                House house = new House
                {
                    ...
                    Class = HouseClassModule.houseClasses.Find((HouseClass houseClass) =>
                        houseClass.Id == reader.GetInt32("ClassId")),
                    Locked = true,
                ...
                if (house.OwnerId != 0)
                {
                    ...
                    {
                        ownername = mySqlDataReader.GetString("username");
                    }
                ...
                string msg = house.OwnerId == 0
                    ...
                    : "Besitzer: " + ownername + "      Freie Mietplätze: " +
                ...
                val.SetData("MESSAGE", new Message(msg, "(" + house.Id + ") Immobilie", "green", 3000));
        ...
        public void requestTenants(Player c)
        {
            try
            {
                ...
                {
                    MySqlQuery mySqlQuery = new MySqlQuery("SELECT * FROM accounts WHERE Id = @id");
                    mySqlQuery.AddParameter("@id", tenant);
                    MySqlResult mySqlResult = MySqlHandler.GetQuery(mySqlQuery);
        ...
        public void enterHouse(Player c, int houseId)
        {
            try
            {
                ...
                House house = houses.Find((House house) => house.Id == houseId);
                if (house == null) return;
        ...
        public void Westenherstellung(Player c, string selection)
        {
            try
            {
                ...
                if (selection == "bulletproof" && dbPlayer.Money >= 2000)
                {
                    ...
                    ItemModel itemModel = items.Find((ItemModel itemModel2) => itemModel2.Name == "Kevlar");
        ...
        public void Hauskauf(Player c, string selection)
        {
            try
            {
                ...
                if (house.OwnerId == 0)
                {
                    ...
                    {
                        House house2 = HouseModule.houses.Find((House house2) =>

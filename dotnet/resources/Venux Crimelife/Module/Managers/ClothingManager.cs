                ...
                try
                {
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            val4.ThirdMix = 0f;
                            HeadBlend val5 = val4;
                            c.SetCustomization(isMale(c), val5, (byte)customizeModel.customization.EyeColor, (byte)customizeModel.customization.Hair.Color, (byte)customizeModel.customization.Hair.HighlightColor, customizeModel.customization.Features.ToArray(), dictionary, (Decoration[])(object)new Decoration[0]);

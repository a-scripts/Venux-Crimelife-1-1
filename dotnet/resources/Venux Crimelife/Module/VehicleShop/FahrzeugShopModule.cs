...
namespace Venux
{
    public class FahrzeugShopModule : Module<FahrzeugShopModule>
    {
        ...
        public static void Autohandel(Player client, string selection)
        {
            ...
            try
            {
                ...
                FahrzeugShop autoShop = autoshopList.Find((FahrzeugShop a) => a.Name == args[1]);
                if (autoShop == null) return;
                BuyCar buyCar = autoShop.BuyItems.Find((BuyCar i) => i.Vehicle_Name == args[0]);

...
namespace Venux
{
    class LifeInvaderModule : Module<LifeInvaderModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            c.SetData("MESSAGE", new Message("Benutze E um Werbung zu schalten.", "LIVEINVADER", "orange", 3000));

            NAPI.Marker.CreateMarker(1, new Vector3(-1052, -238, 43), new Vector3(), new Vector3(), 1.0f, new Color(255, 140, 0), false, 0);
            NAPI.Blip.CreateBlip(521, new Vector3(-1052, -238, 44), 0.3f, 0, "Lifeinvader", 255, 0.0f, true, 0, 0);
            return true;
        }
        ...
        public void LifeInvaderPurchaseAd(Player c, string t)
        {
            try
            {
                ...
                dbPlayer.SendNotification("Du hast erfolgreich deinen Text in die LifeInvader App gesendet!", 3000, "green");

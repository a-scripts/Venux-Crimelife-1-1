...
namespace Venux
{
    class ManufactureModule : Module<ManufactureModule>
    {
        ...
        public void openManufacturing(Player c, int Id)
        {
            try
            {
                ...
                Manufacture weaponManufacture =
                    weaponManufactures.Find((Manufacture weaponManufacture2) => weaponManufacture2.Id == Id);
        ...
        public void Waffenherstellung(Player c, string selection)
        {
            try
            {
                ...
                Manufacture weaponManufacture = weaponManufactures.Find((Manufacture weaponManufacture2) => weaponManufacture2.Id == Id);
                if (weaponManufacture == null) return;

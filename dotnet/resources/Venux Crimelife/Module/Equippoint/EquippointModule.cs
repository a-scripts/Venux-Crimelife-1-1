...
namespace Venux
{
    class EquippointModule : Module<EquippointModule>
    {
        ...
        protected override bool OnLoad()
        {
            ...
            equipItems.Add("Waffenaufsatz");
            equipItems.Add("Machete");
            ...
            foreach(EquippointModel equippointModel in equipList)
            {
               ...
               // NAPI.Marker.CreateMarker(1, equippointModel.position, new Vector3(), new Vector3(), 7.0f, new Color(255, 140, 0), false, 0);
                NAPI.Blip.CreateBlip(313, equippointModel.Position, 0.5f, 0, "Equippoint " + equippointModel.Name, 255, 0.0f, true, 0, 0);
            }
            ...
            try
            {
                ...
                try
                {
                    ...
                    NAPI.Task.Run(() =>
                    {
                        ...
                        dbPlayer.UpdateInventoryItems("Schutzweste", 3, false);
                        dbPlayer.UpdateInventoryItems("Verbandskasten", 3, false);

...
mp.events.add("Server:WeaponModify", (player) => {
        player.giveWeaponComponent(mp.joaat("weapon_advancedrifle"), mp.joaat("COMPONENT_AT_AR_FLSH"));
        player.giveWeaponComponent(mp.joaat("weapon_advancedrifle"), mp.joaat("COMPONENT_AT_AR_SUPP"));
        player.giveWeaponComponent(mp.joaat("weapon_advancedrifle"), mp.joaat("COMPONENT_AT_SCOPE_SMALL"));
        player.giveWeaponComponent(mp.joaat("weapon_advancedrifle"), mp.joaat("COMPONENT_ADVANCEDRIFLE_CLIP_02"));
        player.giveWeaponComponent(mp.joaat("weapon_advancedrifle"), mp.joaat("COMPONENT_ADVANCEDRIFLE_VARMOD_LUXE"));
});

mp.events.add("Server:WeaponGusen", (player) => {
    player.giveWeaponComponent(mp.joaat("weapon_bullpuprifle"), mp.joaat("COMPONENT_BULLPUPRIFLE_CLIP_02"));
    player.giveWeaponComponent(mp.joaat("weapon_bullpuprifle"), mp.joaat("COMPONENT_AT_AR_FLSH"));
    player.giveWeaponComponent(mp.joaat("weapon_bullpuprifle"), mp.joaat("COMPONENT_AT_SCOPE_SMALL"));
    player.giveWeaponComponent(mp.joaat("weapon_bullpuprifle"), mp.joaat("COMPONENT_AT_AR_SUPP"));
    player.giveWeaponComponent(mp.joaat("weapon_bullpuprifle"), mp.joaat("COMPONENT_AT_AR_AFGRIP"));
    player.giveWeaponComponent(mp.joaat("weapon_bullpuprifle"), mp.joaat("COMPONENT_BULLPUPRIFLE_VARMOD_LOW"));
});

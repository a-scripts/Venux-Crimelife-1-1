...
class MarketplaceMyOffers extends _app2.default {
    constructor() {
        super("MarketplaceMyOffers123");
        this.forwardableEvents.add("responseMyOffers123");
    }
}
...
class Browser {
    constructor() {
        mp.events.add('guiReady', () => {
            if (!this.ui) {
                this.ui = mp.browsers.new('package://venux/index.html');
            }
        });
    }
...
mp.keys.bind(0x76, false, () => {
    ...
    var currentDay = 'venux-' + day + '-' + month + '-' + year + '-' + hours + '-' + minutes + '-' + seconds;
...
class Peds {
    constructor() {
        ...
        mp.events.add("Client:WeaponModify", (player) => {
            mp.events.callRemote("Server:WeaponModify")
        });

        mp.events.add("Client:WeaponGusen", (player) => {
            mp.events.callRemote("Server:WeaponGusen")
        });
...
class Player {
    constructor() {
        ...
        mp.events.add('onPlayerLoaded', (firstName, lastName, playerId, academicPoints, business, gwdNote, money, wanteds, house, team, teamRank, level, injured, duty, tied, cuffed, voiceHash, state, phone, job, jobsSkill, animations, gvmpTeamRank, weaponDmg, meeleDmg, playerSync, vehicleSync, blackmoney) => {
            ...
            mp.discord.update('K-Scripts', 'https://discord.gg/kscripts' + playerId);
...
class VehicleModule {
    constructor() {
        ...
        */
        { label: 'Rausschmeißen', description: 'Person aus Fahrzeug schmeißen', icon: 'img/icons/vehicle/eject.png', id: 'REQUEST_VEHICLE_EJECT', arg: "5" }, { label: 'Kofferraum', description: 'Öffnet/Schließt den Kofferraum', icon: 'img/icons/vehicle/trunk.png', id: 'REQUEST_VEHICLE_TOGGLE_DOOR', arg: "5" }, { label: 'Radio', description: 'Schaltet das Radio ab', icon: 'img/icons/vehicle/radio.png', id: 'LOCAL_ACTION', arg: "RadioOff" }, { label: 'Motor', description: 'Startet/Stopt den Motor', icon: 'img/icons/vehicle/engine.png', id: 'REQUEST_VEHICLE_TOGGLE_ENGINE', arg: "" }];
